<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="BTL_LTW_17.WebForms.Login" %>
...
<body>
    <form action="" method="post" class="box" onsubmit="return handleSubmit()" runat="server">
        <div class="content">
            <div class="title">
    ...
    <script>
        //const regexNumberPhone = /(03|05|07|08|09|01[2|6|8|9])+([0-9]{8})\b/;
